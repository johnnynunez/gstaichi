...
if (TI_WITH_OPENGL OR TI_WITH_VULKAN)
    file(GLOB GSTAICHI_TESTS_GFX_UTILS_SOURCE
        "tests/cpp/aot/gfx_utils.cpp")
    list(APPEND GSTAICHI_TESTS_SOURCE ${GSTAICHI_TESTS_GFX_UTILS_SOURCE})
endif()

if(TI_WITH_LLVM)
  file(GLOB GSTAICHI_TESTS_LLVM_SOURCE "tests/cpp/aot/llvm/*.cpp" "tests/cpp/llvm/*.cpp")
  list(APPEND GSTAICHI_TESTS_SOURCE ${GSTAICHI_TESTS_LLVM_SOURCE})
endif()

if(TI_WITH_VULKAN)
  file(GLOB GSTAICHI_TESTS_VULKAN_SOURCE "tests/cpp/aot/vulkan/*.cpp")
  list(APPEND GSTAICHI_TESTS_SOURCE ${GSTAICHI_TESTS_VULKAN_SOURCE})
endif()

if(TI_WITH_OPENGL)
  file(GLOB GSTAICHI_TESTS_OPENGL_SOURCE "tests/cpp/aot/opengl/*.cpp")
  list(APPEND GSTAICHI_TESTS_SOURCE ${GSTAICHI_TESTS_OPENGL_SOURCE})
endif()

if(TI_WITH_DX12)
  file(GLOB GSTAICHI_TESTS_DX12_SOURCE "tests/cpp/aot/dx12/*.cpp")
  list(APPEND GSTAICHI_TESTS_SOURCE ${GSTAICHI_TESTS_DX12_SOURCE})
endif()
