...
if (WIN32)
    ...
    elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU")
        ...
        message(FATAL_ERROR "clang and MSVC are the only supported compilers for GsTaichi compiler development. Consider using 'cmake -DCMAKE_CXX_COMPILER=clang' if you are on Linux.")
    endif()
...
if (LINUX AND (CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64"))
