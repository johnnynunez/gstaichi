...
function(add_gstaichi_example NAME)
...
set(SOURCE_FILE "cpp_examples/${NAME}.cpp")
  ...
  target_link_libraries(${TARGET_NAME} PRIVATE gstaichi_core)
...
add_gstaichi_example(run_snode)
add_gstaichi_example(autograd)
add_gstaichi_example(aot_save)
