...
set(C_API_TESTS_NAME gstaichi_c_api_tests)
if (WIN32)
...
file(GLOB_RECURSE GSTAICHI_C_API_TESTS_SOURCE
        "c_api/tests/*.cpp")

add_executable(${C_API_TESTS_NAME} ${GSTAICHI_C_API_TESTS_SOURCE})
if (WIN32)
...
target_link_libraries(${C_API_TESTS_NAME} PRIVATE gstaichi_c_api)
target_link_libraries(${C_API_TESTS_NAME} PRIVATE gstaichi_common)
...
if(TI_WITH_STATIC_C_API)
    set(C_STATIC_API_TESTS_NAME gstaichi_static_c_api_tests)

    # TODO(#2195):
    # 1. "cpp" -> "cpp_legacy", "cpp_new" -> "cpp"
    # 2. Re-implement the legacy CPP tests using googletest
    file(GLOB_RECURSE GSTAICHI_STATIC_C_API_TESTS_SOURCE
            "c_api/tests/*.cpp")

    add_executable(${C_STATIC_API_TESTS_NAME} ${GSTAICHI_STATIC_C_API_TESTS_SOURCE})
    add_dependencies(${C_STATIC_API_TESTS_NAME} gstaichi_static_c_api)

    target_link_libraries(${C_STATIC_API_TESTS_NAME} PRIVATE $<TARGET_FILE:gstaichi_static_c_api>)
    target_link_libraries(${C_STATIC_API_TESTS_NAME} PRIVATE gstaichi_common)
