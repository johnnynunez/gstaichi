...
def setup_vulkan():
    ...
    if (u.system, u.machine) == ("Linux", "x86_64"):
        ...
        url = (
            f"https://github.com/Genesis-Embodied-AI/gstaichi-sdk-builds/releases/download/vulkan-sdk-1.4.321.1-hp-bump-vulkan-arm-202509151418/vulkansdk-ubuntu-22.04-arm-1.4.321.1.tar.xz"
        )
