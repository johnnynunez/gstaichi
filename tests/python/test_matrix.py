...
@pytest.mark.xfail(platform.system() == "Darwin", reason="CFG seg fault on macOS (added to Linear https://linear.app/genesis-ai-company/issue/CMP-10/fix-cfg-crash-bug)")
@test_utils.test(debug=True)
