"""
Generate AOT modules with GsTaichi nightly (which is definitely an older version
...
cpp_test_filename = "gstaichi_cpp_tests"
capi_test_filename = "gstaichi_c_api_tests"
...
def generate():
    ...
    for x in aot_files:
        ...
        os.environ["GSTAICHI_AOT_FOLDER_PATH"] = curr_dir + "/tests/cpp/aot/python_scripts/" + path_name
        try:
