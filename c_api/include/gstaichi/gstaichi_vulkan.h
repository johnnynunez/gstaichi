...
//
// GsTaichi's Vulkan API gives you further control over the Vulkan version and
...
//
// Necessary detail to share the same Vulkan runtime between GsTaichi and external
// procedures.
//
//
...
//
// Necessary detail to share the same piece of Vulkan buffer between GsTaichi and
// external procedures.
typedef struct TiVulkanMemoryInteropInfo {
  ...
  uint64_t size;
  // Vulkan buffer usage. In most of the cases, GsTaichi requires the
...
//
// Necessary detail to share the same piece of Vulkan image between GsTaichi and
// external procedures.
typedef struct TiVulkanImageInteropInfo {
  ...
  // Vulkan image usage. In most cases, GsTaichi requires the
