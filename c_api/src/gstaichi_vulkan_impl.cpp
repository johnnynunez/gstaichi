...
VulkanRuntime::VulkanRuntime() : GfxRuntime(gstaichi::Arch::vulkan) {
}
gstaichi::lang::vulkan::VulkanDevice &VulkanRuntime::get_vk() {
  return static_cast<gstaichi::lang::vulkan::VulkanDevice &>(get());
}
...
VulkanRuntimeImported::Workaround::Workaround(
  ...
  if (!gstaichi::lang::vulkan::VulkanLoader::instance().init(
          params.get_proc_addr)) {
    throw std::runtime_error("Error loading vulkan");
  }
  gstaichi::lang::vulkan::VulkanLoader::instance().load_instance(params.instance);
  gstaichi::lang::vulkan::VulkanLoader::instance().load_device(params.device);
  ...
  gstaichi::lang::DeviceCapabilityConfig caps{};

  if (api_version >= VK_API_VERSION_1_2) {
    caps.set(gstaichi::lang::DeviceCapability::spirv_version, 0x10500);
  } else if (api_version >= VK_API_VERSION_1_1) {
    caps.set(gstaichi::lang::DeviceCapability::spirv_version, 0x10300);
  } else {
    caps.set(gstaichi::lang::DeviceCapability::spirv_version, 0x10000);
  }

  // (penguinliong) Will bring it back after devcap.
  /*
  if (api_version > VK_API_VERSION_1_0) {
    caps.set(gstaichi::lang::DeviceCapability::spirv_has_physical_storage_buffer,
             true);
  }
  */
  ...
  vk_device.init_vulkan_structs(
      const_cast<gstaichi::lang::vulkan::VulkanDevice::Params &>(params));
}
VulkanRuntimeImported::VulkanRuntimeImported(
    uint32_t api_version,
    const gstaichi::lang::vulkan::VulkanDevice::Params &params)
    : inner_(api_version, params),
      gfx_runtime_(gstaichi::lang::gfx::GfxRuntime::Params{&inner_.vk_device}) {
}
gstaichi::lang::Device &VulkanRuntimeImported::get() {
  return static_cast<gstaichi::lang::Device &>(inner_.vk_device);
}
...
make_vulkan_runtime_creator_params() {
  ...
  gstaichi::lang::vulkan::VulkanDeviceCreator::Params params{};
...
gstaichi::lang::gfx::GfxRuntime &VulkanRuntimeImported::get_gfx_runtime() {
  return gfx_runtime_;
}
...
VulkanRuntimeOwned::VulkanRuntimeOwned(
    ...
    : vk_device_creator_(params),
      gfx_runtime_(
          gstaichi::lang::gfx::GfxRuntime::Params{vk_device_creator_.device()}) {
}
gstaichi::lang::Device &VulkanRuntimeOwned::get() {
  return *static_cast<gstaichi::lang::Device *>(vk_device_creator_.device());
}
gstaichi::lang::gfx::GfxRuntime &VulkanRuntimeOwned::get_gfx_runtime() {
  return gfx_runtime_;
}

TiImage VulkanRuntime::allocate_image(const gstaichi::lang::ImageParams &params) {
...
TiRuntime ti_import_vulkan_runtime(
  ...
  gstaichi::lang::vulkan::VulkanDevice::Params params{};
...
TiMemory ti_import_vulkan_memory(
  ...
  Runtime *runtime2 = (Runtime *)runtime;
  gstaichi::lang::vulkan::VulkanDevice &vk_runtime =
      static_cast<VulkanRuntime *>(runtime2)->get_vk();

  vkapi::IVkBuffer buffer = vkapi::create_buffer(
      vk_runtime.vk_device(), interop_info->buffer, interop_info->usage);
  gstaichi::lang::DeviceAllocation devalloc = vk_runtime.import_vkbuffer(
...
TiImage ti_import_vulkan_image(TiRuntime runtime,
  ...
  gstaichi::lang::DeviceAllocation image2 =
      vk_runtime.import_vk_image(image, image_view, layout);

  gstaichi::lang::ImageLayout layout2 = (gstaichi::lang::ImageLayout)layout;
