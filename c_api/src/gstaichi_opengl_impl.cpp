...
OpenglRuntime::OpenglRuntime()
    : GfxRuntime(gstaichi::Arch::opengl),
      device_(),
      gfx_runtime_(gstaichi::lang::gfx::GfxRuntime::Params{&device_}) {
  gstaichi::lang::DeviceCapabilityConfig caps{};
  caps.set(gstaichi::lang::DeviceCapability::spirv_has_int64, true);
  caps.set(gstaichi::lang::DeviceCapability::spirv_has_float64, true);
  caps.set(gstaichi::lang::DeviceCapability::spirv_version, 0x10300);
  get_gl().set_caps(std::move(caps));
}
gstaichi::lang::Device &OpenglRuntime::get() {
  return static_cast<gstaichi::lang::Device &>(device_);
}
gstaichi::lang::gfx::GfxRuntime &OpenglRuntime::get_gfx_runtime() {
  return gfx_runtime_;
}
...
TiRuntime ti_import_opengl_runtime(TiOpenglRuntimeInteropInfo *interop_info,
  ...
  gstaichi::lang::opengl::imported_process_address = interop_info->get_proc_addr;
  gstaichi::lang::opengl::set_gles_override(use_gles);
...
void ti_export_opengl_runtime(TiRuntime runtime,
  ...
  interop_info->get_proc_addr =
      gstaichi::lang::opengl::kGetOpenglProcAddr.value();
  TI_CAPI_TRY_CATCH_END();
}
...
TiMemory ti_import_opengl_memory(TiRuntime runtime,
  ...
  devalloc.alloc_id = (gstaichi::lang::DeviceAllocationId)interop_info->buffer;
...
TiImage ti_import_opengl_image(TiRuntime runtime,
  ...
  OpenglRuntime *runtime2 = static_cast<OpenglRuntime *>((Runtime *)runtime);
  gstaichi::lang::opengl::GLImageAllocation gl_image{};
  ...
  gstaichi::lang::DeviceAllocation devalloc = runtime2->get_gl().import_image(
...
void ti_export_opengl_image(TiRuntime runtime,
  ...
  const gstaichi::lang::opengl::GLImageAllocation &gl_image =
