...
from gstaichi.tools import diagnose, video
...
class GsTaichiMain:
    ...
    def gallery(self, arguments: list = sys.argv[2:]):
        """Use mouse to select and run gstaichi examples in an interactive gui."""
        ...
        gui = ti.GUI("GsTaichi Gallery", res=(width, height))
        ncols = 4
    ...
    def module(self, arguments: list = sys.argv[2:]):
        ...
        from gstaichi import _ti_module  # pylint: disable=C0415
