...
# 2D Euler Fluid Simulation using GsTaichi, originally created by @Lee-abcde
import gstaichi as ti
import gstaichi.math as tm
from gstaichi.examples.patterns import gstaichi_logo
...
def init_field():
    ...
    for i, j in ti.ndrange(eulerSimParam["shape"][0] * 4, eulerSimParam["shape"][1] * 4):
        # 4x4 super sampling:
        ret = gstaichi_logo(ti.Vector([i, j]) / (eulerSimParam["shape"][0] * 4))
