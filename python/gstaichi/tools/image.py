...
def cook_image_to_bytes(img):
    """
    Takes a NumPy array or GsTaichi field of any type.
...
def imshow(img, title="imshow"):
    """Display a gstaichi.field or a numpy.ndarray in a GsTaichi GUI window or an interactive Ipython notebook.
