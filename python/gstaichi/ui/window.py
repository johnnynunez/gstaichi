...
from gstaichi.lang.impl import Field, default_cfg, get_runtime
from gstaichi.ui.staging_buffer import get_depth_ndarray
...
class Window:
    ...
    def is_pressed(self, *keys):
        ...
        Args:
            keys (list[:mod:`~gstaichi.ui.constants`]): The keys to be matched.
    ...
    def get_canvas(self):
        """Returns a canvas handle. See :class`~gstaichi.ui.canvas.Canvas`"""
        return Canvas(self.window.get_canvas())

    def get_scene(self):
        """Returns a scene handle. See :class`~gstaichi.ui.scene.SceneV2`"""
        return SceneV2(self.window.get_scene())

    @property
    def GUI(self):
        """Returns a IMGUI handle. See :class`~gstaichi.ui.ui.Gui` This is an
        deprecated interface, please use `~gstaichi.ui.Window.get_gui` instead.
        """
        return self.get_gui()

    def get_gui(self):
        """Returns a IMGUI handle. See :class`~gstaichi.ui.ui.Gui`"""
