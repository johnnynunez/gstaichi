...
from gstaichi._kernels import tensor_to_image, vector_to_fast_image, vector_to_image
...
class GUI:
    """GsTaichi Graphical User Interface class.
    ...
    Args:
        ...
        fast_gui (bool, optional): Specify whether to use fast gui mode of
            GsTaichi. Default is False.

    Returns:
        :class:`~gstaichi.misc.gui.GUI` :The created gstaichi GUI object.
    ...
    def slider(self, text, minimum, maximum, step=1):
        ...
        Return:
            :class:`~gstaichi.misc.gui.GUI.WidgetValue` :The created slider object.
        """
    ...
    def label(self, text):
        ...
        Return:
            :class:`~gstaichi.misc.gui.GUI.WidgetValue` :The created label object.
    ...
    def set_image(self, img):
        ...
        Args:
            img (Union[:class:`gstaichi.field`, `numpy.array`]): The color array \
        ...
        if self.fast_gui:
            assert isinstance(
                img, gstaichi.lang.matrix.MatrixField
        ...
        if isinstance(img, ScalarField):
        ...
        elif isinstance(img, gstaichi.lang.matrix.MatrixField):
            ...
            raise ValueError(f"GUI.set_image only takes a GsTaichi field or NumPy array, not {type(img)}")
    ...
    def get_events(self, *e_filter):
        ...
        Returns:
            :class:`~gstaichi.misc.gui.GUI.EVENT`: A list of events that are triggered.
        """
    ...
    def get_key_event(self):
        ...
        Returns:
            :class:`~gstaichi.misc.gui.GUI.EVENT`: The keyboard triggered event.
        """
