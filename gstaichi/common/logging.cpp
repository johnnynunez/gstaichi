...
Logger::Logger() {
#ifdef ANDROID
  console_ = spdlog::android_logger_mt("android", "gstaichi");
...
void Logger::error(const std::string &s, bool raise_exception) {
  ...
  if (gstaichi::CoreState::get_instance().trigger_gdb_when_crash) {
...
Logger &Logger::get_instance() {
  ...
  // gstaichi/system/hacked_signal_handler.cpp. We instantiate a global
