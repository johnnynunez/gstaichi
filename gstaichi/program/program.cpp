// Program, context for GsTaichi program execution
...
#else
      TI_ERROR("This gstaichi is not compiled with DX12");
#endif
    }
#else
    TI_ERROR("This gstaichi is not compiled with LLVM");
#endif
...
#else
    TI_ERROR("This gstaichi is not compiled with Metal")
#endif
...
#else
    TI_ERROR("This gstaichi is not compiled with Vulkan")
#endif
...
#else
    TI_ERROR("This gstaichi is not compiled with DX11");
#endif
...
#else
    TI_ERROR("This gstaichi is not compiled with OpenGL");
#endif
...
void Program::destroy_snode_tree(SNodeTree *snode_tree) {
  ...
  // a GsTaichi Kernel to read/write the field in a JIT manner, which caches the
