// Program  - GsTaichi program execution context
...
class TI_DLL_EXPORT Program {
 public:
  ...
  T fetch_result(int i) {
    return gstaichi_union_cast_with_different_sizes<T>(fetch_result_uint64(i));
  }
 ...
 private:
  ...
  // TODO: Move ndarrays_, argpacks_ to be managed by runtime
