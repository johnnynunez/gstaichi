...
class TI_DLL_EXPORT Renderer {
 public:
  void init(lang::Program *prog, GsTaichiWindow *window, const AppConfig &config);
  ~Renderer();
  ...
  void set_image(gstaichi::lang::Texture *tex);
  ...
  gstaichi::lang::StreamSemaphore get_render_complete_semaphore();
 ...
 private:
  ...
  gstaichi::lang::StreamSemaphore render_complete_semaphore_{nullptr};
