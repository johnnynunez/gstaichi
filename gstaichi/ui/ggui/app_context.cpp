...
void AppContext::init_with_vulkan(Program *prog,
  ...
  if (config.ti_arch != Arch::vulkan || prog == nullptr) {
    gstaichi::lang::vulkan::VulkanDeviceCreator::Params evd_params{};
    ...
    graphics_device_ = static_cast<gstaichi::lang::GraphicsDevice *>(
  ...
  if (config.show_window) {
    ...
    native_surface_ = make_vk_surface(
        static_cast<gstaichi::lang::vulkan::VulkanDevice *>(graphics_device_)
            ->vk_instance());
  }
}
...
gstaichi::lang::GraphicsDevice &AppContext::device() {
  return *graphics_device_;
}

const gstaichi::lang::GraphicsDevice &AppContext::device() const {
  return *graphics_device_;
}
...
gstaichi::lang::Pipeline *AppContext::get_customized_raster_pipeline(
...
gstaichi::lang::Pipeline *AppContext::get_compute_pipeline(
...
GsTaichiWindow *AppContext::gstaichi_window() const {
  return gstaichi_window_;
}
