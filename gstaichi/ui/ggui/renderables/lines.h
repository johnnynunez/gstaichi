...
class Lines final : public Renderable {
 ...
 private:
  ...
  gstaichi::lang::Pipeline *quad_expand_pipeline_{nullptr};

  std::unique_ptr<gstaichi::lang::DeviceAllocationGuard> vbo_translated_{nullptr};
  std::unique_ptr<gstaichi::lang::DeviceAllocationGuard> ibo_translated_{nullptr};
};
