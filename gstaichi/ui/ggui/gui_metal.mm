...
GuiMetal::GuiMetal(AppContext *app_context, GsTaichiWindow *window) {
  ...
  auto &device =
      static_cast<gstaichi::lang::metal::MetalDevice &>(app_context_->device());
...
void GuiMetal::draw(gstaichi::lang::CommandList *cmd_list) {
