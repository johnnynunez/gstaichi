...
class LlvmProgramImpl : public ProgramImpl {
 ...
 public:
  ...
  // GsTaichiLLVMContext. Upon destruction, there's an implicit requirement that
  // GsTaichiLLVMContext has to stay alive until all the llvm::Modules are
  ...
  // instead of owned by GsTaichiLLVMContext.
  //
  ...
  ~LlvmProgramImpl() override {
    ...
    // destructs before
    // "LlvmRuntimeExecutor::GsTaichiLLVMContext::ThreadSafeContext"
