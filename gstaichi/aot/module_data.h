...
struct ModuleData {
  std::unordered_map<std::string, CompiledGsTaichiKernel> kernels;
  std::unordered_map<std::string, CompiledGsTaichiKernel> kernel_tmpls;
