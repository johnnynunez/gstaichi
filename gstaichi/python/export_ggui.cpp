...
#include "gstaichi/ui/ggui/window.h"
#include "gstaichi/ui/common/canvas_base.h"
#include "gstaichi/ui/common/camera.h"
...
#include "gstaichi/ui/common/gui_base.h"
...
struct PyScene {
  ...
  void mesh(FieldInfo vbo,
    ...
    renderable_info.display_mode = show_wireframe
                                       ? gstaichi::lang::PolygonMode::Line
                                       : gstaichi::lang::PolygonMode::Fill;
...
void export_ggui(py::module &m) {
  ...
  py::enum_<FieldSource>(m, "FieldSource")
      .value("GsTaichiNDarray", FieldSource::GsTaichiNDarray)
  ...
  py::enum_<gstaichi::lang::PolygonMode>(m, "DisplayMode")
      .value("Fill", gstaichi::lang::PolygonMode::Fill)
      .value("Line", gstaichi::lang::PolygonMode::Line)
      .value("Point", gstaichi::lang::PolygonMode::Point)
      .export_values();
}
