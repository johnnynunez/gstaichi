...
#endif
#ifdef TI_WITH_OPENGL
  m.def("with_opengl", gstaichi::lang::opengl::is_opengl_api_available,
...
#endif
#ifdef TI_WITH_DX11
  m.def("with_dx11", gstaichi::lang::directx11::is_dx_api_available);
#else
  m.def("with_dx11", []() { return false; });
#endif
#ifdef TI_WITH_DX12
  m.def("with_dx12", gstaichi::lang::directx12::is_dx12_api_available);
#else
