...
std::vector<uint8_t> global_optimize_module(llvm::Module *module,
  ...
  // Lower gstaichi intrinsic first.
  module_pass_manager.add(createGsTaichiIntrinsicLowerPass(&config));
  ...
  module_pass_manager.add(createGsTaichiRuntimeContextLowerPass());
  ...
  if (config.print_kernel_llvm_ir_optimized) {
    static FileSequenceWriter writer(
        "gstaichi_kernel_dx12_llvm_ir_optimized_{:04d}.ll",
